...
public class RemoveStaffJFrame extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame2
     */
    public RemoveStaffJFrame() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
          String staffName = jTextField1.getText().trim();

        if (staffName.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter a staff name.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        Staff staffToRemove = TestMuseum.m1.searchStaff(staffName);

        if (staffToRemove != null) {
            boolean removed = TestMuseum.m1.removeStaff(staffToRemove);
            if (removed) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveStaffJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveStaffJFrame().setVisible(true);
            }
        });
    }
